...
if(isset($_POST['submit'])){
    ...
    }else if( DatabaseMethod::updateApartment($id,$apartmentNo,$name) )
...
<body>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <form role="form" method="post">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="apartmentNo" id="apartmentNo">
                                            <p class="help-block">Apartment Number.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Apartment Name</label>
                                            <input class="form-control" name="name" id="apartmentName">
    ...
    <script>
        $('#apartment').on('change',function(){
            ...
            $.get('/databaseMethods.php',{apartmentId:apartmentId},function(data){
                apartmentObject = JSON.parse(data);
                
                $('#apartmentName').val(apartmentObject.name);
                $('#apartmentId').val(apartmentObject.id);
                $('#apartmentNo').val(apartmentObject.apartment_no);
